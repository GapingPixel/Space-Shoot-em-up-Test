...
namespace ShmupBoss
{
    ...
    public abstract class Weapon : MonoBehaviour
    {
        ...
        void Start()
        {
            MissileObject = GameObject.Find("Missile");        
            //MissileObject = Instantiate(MissileObject, new Vector2(transform.position.x, transform.position.y), Quaternion.identity);
        ...
        {          
            ...
            if (Time.time > FiringTime)
            {
                ...
                //MissileObject.move = true;
                    
                //Instantiate(MissileObject, new Vector2(transform.position.x, transform.position.y), Quaternion.identity);
